...
class CParSkatGroup extends CParMain {
    ...
    function __construct() {
        ...
        $this->decimal = false;
        $this->site_link = "https://skatgroup.ru";
        $this->author = "Никита";
        $this->batches = 1;
    }
    ...
    function processParsing() {
        ...
        $url = ["https://skatgroup.ru"];
        $data = [
            "title" => "Категории",
            "log" => "ссылок на категории",
            "category_selector" => '//div[@class="bot-nav__list"]/div/a/@href',
            "absolute_link" => false
        ];

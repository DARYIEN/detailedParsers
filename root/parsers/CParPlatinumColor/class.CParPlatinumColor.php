...
class CParPlatinumColor extends CParMain {
    ...
    function __construct() {
        ...
        $this->decimal = false;
        $this->site_link = "https://platinum-color.ru/";
        $this->author = "Никита";
        $this->batches = 30;
    }
    ...
    function processParsing() {
        ...
        $url = ["https://platinum-color.ru/catalog/"];
        $data = [
            "title" => "Категории",
            "log" => "ссылок на категории",
            "category_selector" => '//td[@class="section_info"]/ul/li/a/@href',
            "absolute_link" => false
        ];
    ...
    $base_selector = '//div[@class="catalog_block items block_list grid-list grid-list--compact grid-list--no-gap grid-list--items-5-1200 grid-list--items-4-992 grid-list--items-3-768 grid-list--items-2-601"]/div';
        $data = [
            "title" => "Ссылки на товары",
            "log" => "ссылок на товары",
            "title_selector" => [$base_selector . '//div[@class="item-title"]/a'],
            "absolute_link" => false,
            "big_data" => true
        ];
        ...
        $data = [
            ...
            "price_selector" => '//div[@class="middle_info main_item_wrapper"]//div[@class="price"]',

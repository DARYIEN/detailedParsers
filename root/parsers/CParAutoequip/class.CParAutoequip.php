...
class CParAutoequip extends CParMain {
    ...
    function processParsing() {
        ...
        $data = [
            ...
            "crumb_selector" => '//div[@class="crumbs crumbs_6"]/a',
            "crumb_begin" => 3,
            "crumb_end" => 1,
            ...
            "prop_type" => "dual",
            "prop_selector" => '//div[@class="general-characteristics block-characteristics"]/div',
            "prop1" => './/span[1]',
            "prop2" => './/span[2]',

            "description_selector" => '//class[@id="mb10-not-last overtext text"]',
        ];
        $this->batchSize = 4000;

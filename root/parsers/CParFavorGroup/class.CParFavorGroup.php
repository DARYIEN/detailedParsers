...
class CParFavorGroup extends CParMain {
    ...
    function __construct() {
        ...
        $this->decimal = false;
        $this->site_link = "https://favor-group.ru";
        $this->author = "Никита";
        $this->batches = 15;
    }
    ...
    function processParsing() {
        ...
        $url = ["https://favor-group.ru/catalog/"];
        $data = [
            "title" => "Категории",
            "log" => "ссылок на категории",
            "category_selector" => '//div[@class="list row"]/div/link/@href',
            "absolute_link" => false
        ];
        ...
        $data = [
            ...
            "title_selector" => ['//div[@class="row"]/div//div[@class="name"]/a'],
            "absolute_link" => false,
            "big_data" => true
        ];
        ...
        $data = [
            ...
            "crumb_selector" => '//nav[@id="navigation"]/div/a/span',
            "crumb_begin" => 1,
            "crumb_end" => 1,
            "title_selector" => '//h1[@id="pagetitle"]',
            "price_selector" => '//div[@class="prices"]//span[@class="price_value"]',
            "unit_selector" => '',

            "one_image_selector" => '',
            "image_selector" => '//div[@class="image-slider"]/div/link',

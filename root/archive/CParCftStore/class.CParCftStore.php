...
class CParCftStore extends CParMain {
    ...
    function processParsing() {
        ...
        $data = [
            ...
            "prop1" => './/th',
            "prop2" => './/td/p/a',
            "description_selector" => '//div[@class="woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content wc-tab"] | //div[@class="woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content wc-tab"]/ul/li',
        ];
        $this->batchSize = 4000;

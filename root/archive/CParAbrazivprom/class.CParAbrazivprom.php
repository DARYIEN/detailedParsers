...
class CParAbrazivprom extends CParMain {
    ...
    function processParsing() {
        ...
        $data = [
            ...
            "one_image_selector" => '//div[@class="thumbnails"]/div[@class="image"]//img',
            "image_selector" => '//div[@class="image-additional"]/a/img',
            "image_html_argument" => "src",
            "absolute_link" => true,

            "prop_type" => "dual",
            "prop_selector" => '//div[@id="tab-description"]//table["table table-bordered"]//tr',
            "prop1" => './/td[1]',
            "prop2" => './/td[2]',
            ...
            "target_categories" => [
                ...
                'Запасные части к безвоздушным окрасочным аппаратам',
                'Комплектующие к безвоздушным окрасочным аппаратам',
                'Сварочное оборудование',
                'Запасные части Devilbiss',
        ...
        $this->parseSave($productsData, $data);
    }
}
